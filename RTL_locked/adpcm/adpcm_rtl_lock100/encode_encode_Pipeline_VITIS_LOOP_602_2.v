...
assign add_ln602_fu_109_p2 = (ap_sig_allocacmp_i_2 + 3'd1);
...
assign delay_bpl_address0 = delay_bpl_addr_reg_215_pp0_iter3_reg;

assign delay_bpl_address1 = delay_bpl_addr_reg_215_pp0_iter1_reg;

assign delay_bpl_d0 = (wd3_fu_171_p4 + or_ln608_fu_149_p2);
...
assign icmp_ln602_fu_103_p2 = ((ap_sig_allocacmp_i_2 == 3'd6) ? 1'b1 : 1'b0);

assign or_ln608_fu_149_p2 = (sext_ln608_1_fu_145_p1 | 32'd128);

assign sext_ln608_1_fu_145_p1 = $signed(tmp_1_fu_137_p3);

assign sext_ln608_fu_155_p1 = delay_bpl_load_reg_226;

assign shl_ln5_fu_158_p3 = {{delay_bpl_load_reg_226}, {8'd0}};

assign sub_ln608_fu_165_p2 = ($signed(shl_ln5_fu_158_p3) - $signed(sext_ln608_fu_155_p1));

assign tmp_1_fu_137_p3 = {{tmp_fu_130_p3}, {8'd0}};
