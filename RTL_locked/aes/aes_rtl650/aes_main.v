...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state8)) begin
        key_address0 = (5'd15 ^ new_locking_key[4:0]);
    end else if ((1'b1 == ap_CS_fsm_state7)) begin
        key_address0 = (5'd13 ^ new_locking_key[9:5]);
    end else if ((1'b1 == ap_CS_fsm_state6)) begin
        key_address0 = (5'd11 ^ new_locking_key[14:10]);
    end else if ((1'b1 == ap_CS_fsm_state5)) begin
        key_address0 = (5'd9 ^ new_locking_key[19:15]);
    end else if ((1'b1 == ap_CS_fsm_state4)) begin
        key_address0 = (5'd7 ^ new_locking_key[24:20]);
    end else if ((1'b1 == ap_CS_fsm_state3)) begin
        key_address0 = (5'd5 ^ new_locking_key[29:25]);
    end else if ((1'b1 == ap_CS_fsm_state2)) begin
        key_address0 = (5'd3 ^ new_locking_key[34:30]);
    end else if ((1'b1 == ap_CS_fsm_state1)) begin
        key_address0 = (5'd1 ^ new_locking_key[39:35]);
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state8)) begin
        key_address1 = (5'd14 ^ new_locking_key[44:40]);
    end else if ((1'b1 == ap_CS_fsm_state7)) begin
        key_address1 = (5'd12 ^ new_locking_key[49:45]);
    end else if ((1'b1 == ap_CS_fsm_state6)) begin
        key_address1 = (5'd10 ^ new_locking_key[54:50]);
    end else if ((1'b1 == ap_CS_fsm_state5)) begin
        key_address1 = (5'd8 ^ new_locking_key[59:55]);
    end else if ((1'b1 == ap_CS_fsm_state4)) begin
        key_address1 = (5'd6 ^ new_locking_key[64:60]);
    end else if ((1'b1 == ap_CS_fsm_state3)) begin
        key_address1 = (5'd4 ^ new_locking_key[69:65]);
    end else if ((1'b1 == ap_CS_fsm_state2)) begin
        key_address1 = ((5'd2 ^ new_locking_key[74:70])^ new_locking_key[89:85]);
    end else if ((1'b1 == ap_CS_fsm_state1)) begin
        key_address1 = ((5'd0 ^ new_locking_key[79:75])^ new_locking_key[84:80]);
    end else begin
        key_address1 = 'bx;
    end
end
