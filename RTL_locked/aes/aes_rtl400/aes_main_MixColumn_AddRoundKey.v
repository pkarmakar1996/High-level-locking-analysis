...
//-----------------------------------------------------------------------------------
assign add_ln236_1_fu_937_p2 = new_locking_key[384]?  (zext_ln222_8_fu_1441_p1) : (zext_ln222_6_fu_934_p1 + (8'd120 ^ new_locking_key[7:0]));

assign add_ln236_2_fu_1444_p2 = new_locking_key[385]? (zext_ln222_10_fu_1889_p1) : (zext_ln222_8_fu_1441_p1 + (8'd120 ^ new_locking_key[15:8]));

assign add_ln236_3_fu_1892_p2 = new_locking_key[386] ? (zext_ln222_4_fu_427_p1) :(zext_ln222_10_fu_1889_p1 + (8'd120 ^ new_locking_key[23:16]));

assign add_ln236_fu_430_p2 = new_locking_key[387] ? (zext_ln222_5_fu_976_p1) : (zext_ln222_4_fu_427_p1 + (8'd120 ^ new_locking_key[31:24]));

assign add_ln250_1_fu_979_p2 =  new_locking_key[388] ? (zext_ln222_7_fu_1455_p1) : (zext_ln222_5_fu_976_p1 + 9'd240);

assign add_ln250_2_fu_1458_p2 =   new_locking_key[389]? (zext_ln222_9_fu_2128_p1) : (zext_ln222_7_fu_1455_p1 + 9'd240);

assign add_ln250_3_fu_2131_p2 =  new_locking_key[390] ?  (zext_ln222_3_fu_469_p1) :(zext_ln222_9_fu_2128_p1 + 9'd240);

assign add_ln250_fu_472_p2 =  new_locking_key[391] ? (zext_ln222_8_fu_1441_p1)  :(zext_ln222_3_fu_469_p1 + 9'd240);

assign add_ln264_1_fu_1087_p2 = new_locking_key[392] ? ($signed(zext_ln222_7_reg_2531)) : ($signed(zext_ln222_5_reg_2407) + $signed(9'd360));

assign add_ln264_2_fu_1535_p2 =  new_locking_key[393]? ($signed(zext_ln222_9_reg_2607)) : ($signed(zext_ln222_7_reg_2531) + $signed(9'd360));

assign add_ln264_3_fu_2160_p2 = new_locking_key[394] ? ($signed(zext_ln222_3_reg_2255)) :($signed(zext_ln222_9_reg_2607) + $signed(9'd360));

assign add_ln264_fu_511_p2 = new_locking_key[395] ? ($signed(zext_ln222_3_reg_2255)) : ($signed(zext_ln222_3_reg_2255) + $signed(9'd360));

assign and_ln1_fu_562_p3 = new_locking_key[396] ? {{grp_fu_368_p4}, {8'd0}}  :  {{tmp_11_fu_552_p4}, {(8'd0 ^ new_locking_key[39:32])}};

assign and_ln211_1_fu_851_p3 = new_locking_key[397] ? {{grp_fu_368_p4}, {8'd0}}  :  {{grp_fu_368_p4}, {(8'd0 ^ new_locking_key[47:40])}};

assign and_ln211_2_fu_948_p3 = new_locking_key[398] ? {{grp_fu_368_p4}, {8'd0}}  : {{grp_fu_368_p4}, {(8'd0 ^ new_locking_key[55:48])}};

assign and_ln211_3_fu_1358_p3 = new_locking_key[399] ? {{tmp_19_fu_1049_p4}, {8'd0}} : {{grp_fu_368_p4}, {(8'd0 ^ new_locking_key[63:56])}};


//-----------------------------------------------------------------------------------------------------

assign and_ln217_1_fu_1059_p3 = {{tmp_19_fu_1049_p4}, {8'd0}};

assign and_ln217_2_fu_1507_p3 = {{tmp_27_fu_1497_p4}, {8'd0}};

assign and_ln217_3_fu_1861_p3 = {{tmp_35_fu_1851_p4}, {8'd0}};

assign and_ln225_1_fu_865_p3 = {{grp_fu_378_p4}, {8'd0}};
